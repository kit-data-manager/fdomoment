...
// SPDX licenses data
const SPDX_LICENSES: SPDXLicense[] = [
...
// Function to get SPDX licenses
export const getSPDXLicenses = (): SPDXLicense[] => {
    return SPDX_LICENSES;
};

// Function to search SPDX licenses by query
export const searchSPDXLicenses = (query: string): SPDXLicense[] => {
  if (!query.trim()) {
    return [];
  }
